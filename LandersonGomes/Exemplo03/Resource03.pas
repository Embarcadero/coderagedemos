...
begin
  // Sample code
  AResponse.Body.SetValue(TJSONString.Create('coderage202503'), True);
end;
...
begin
  ...
  // Sample code
  AResponse.Body.SetValue(TJSONString.Create('coderage202503 ' + LItem), True);
end;
